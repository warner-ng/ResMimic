...
class G1HOIBikeCari4DCfg(G1HOICfg):
    class env(G1HOICfg.env):
        ...
        object_root_z_bias = 0.200  # overwritten by run_cari4d_bike_resmimic.sh
        object_root_pos_offset = [-0.650, -0.250, 0.000]  # overwritten by run_cari4d_bike_resmimic.sh
        human_root_rot_offset_deg = [0.0, 0.0, 0.0]  # overwritten by run_cari4d_bike_resmimic.sh
        object_root_rot_offset_deg = [-90.0, 60.0, -0.0]  # overwritten by run_cari4d_bike_resmimic.sh
        ...
        motion_global_rot_offset_deg = [-85.0, 90.0, 0.0]  # overwritten by run_cari4d_bike_resmimic.sh
        motion_global_pos_offset = [-3.000, 0.000, 1.000]  # overwritten by run_cari4d_bike_resmimic.sh
