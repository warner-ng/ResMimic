#!/usr/bin/env python3
"""Export a ResMimic G1 human pkl to a self-consistent BeyondMimic motion.npz."""
...
parser = argparse.ArgumentParser(description="Export ResMimic G1 pkl to BeyondMimic motion.npz.")
parser.add_argument("--human_pkl", required=True, help="ResMimic aligned human pkl.")
