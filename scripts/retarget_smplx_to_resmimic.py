...
def parse_args():
    parser = argparse.ArgumentParser(description="Retarget SMPL-X npz to ResMimic human motion using GMR.")
    parser.add_argument("--tag", type=str, required=True)
    parser.add_argument("--robot", type=str, default="unitree_g1")
    parser.add_argument("--tgt_fps", type=int, default=30)
    parser.add_argument("--resmimic_root", type=str, default="/home/warner/_projects/ResMimic")
...
def main():
    ...
    print("[Done] Retargeted SMPL-X to ResMimic human motion:")
